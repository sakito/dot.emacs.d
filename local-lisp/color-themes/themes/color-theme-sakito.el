...
(defun color-theme-sakito ()
   ...
   (color-theme-install
    '(color-theme-deep-blue
      ...
      (rst-level-1-face ((t (:background "grey30" :foreground "black"))) t)
      (rst-level-2-face ((t (:background "grey28" :foreground "black"))) t)
      (rst-level-3-face ((t (:background "grey26" :foreground "black"))) t)
      (rst-level-4-face ((t (:background "grey24" :foreground "black"))) t)
      (rst-level-5-face ((t (:background "grey22" :foreground "black"))) t)
      (rst-level-6-face ((t (:background "grey20" :foreground "black"))) t)
      )))
