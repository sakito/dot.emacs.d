   ...
   (color-theme-install
    (append
     (list
      ...
      `(secondary-selection ((t (:background ,yellow1 :foreground "gray10"))))
      ...
      `(highlight ((t (:background ,color-bg1))))
      `(highlight-current-line ((t (:background ,color-bg1))))
      ...
      ;; diff
      `(diff-added ((t (:background "gray26" :foreground "LightGoldenrod1" :inverse-video t))))
      `(diff-removed ((t (:background "gray26" :foreground "deep sky blue" :inverse-video t))))
      `(diff-changed ((t (:foreground ,skyblue :inverse-video t))))
      `(diff-context ((t (:foreground "grey70"))))
      `(diff-file-header ((t (:bold t :background "grey60" :foreground ,yellow1 :weight bold))))
      ...
      `(font-lock-regexp-grouping-construct ((t (:foreground ,orange2))))
